...
export function AboutMe() {
  return <div className="flex flex-col gap-4 items-between mt-4">
    ...
    <Body>
      I'm a software engineer with 3 years of experience as a web developer. Teamwork is my favorite way to learn. Always looking to improve the quality of my code to make it more readable and maintainable. 
      </Body>
      <Body>  
