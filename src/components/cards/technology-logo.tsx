...
const TechnologyLogo: React.FC<Props> = ({ tech }) => {
  return (
    <div className="flex h-48 flex-col items-center  rounded-lg border border-black bg-light-card shadow-lg dark:border-gray-200 dark:bg-dark-card entrance-animation">
