...
interface BreadcrumbContextType {
  ...
  setCustomBreadcrumb: (path: string, title: string) => void
...
export function BreadcrumbProvider({
  ...
  const setCustomBreadcrumb = useCallback((path: string, title: string) => {
    setCustomBreadcrumbs((prev) => ({ ...prev, [path]: title }))
  }, [])
  ...
  return (
    <BreadcrumbContext.Provider
      value={{ customBreadcrumbs, setCustomBreadcrumb, clearCustomBreadcrumb }}
    >
      {children}
    </BreadcrumbContext.Provider>
  )
